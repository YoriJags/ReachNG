...
async def lifespan(app: FastAPI):
    ...
    from services.subscription_invoice import ensure_receipt_indexes
...
app.include_router(meta_messaging_router)  # Meta IG/Messenger webhook — signature-verified, dormant by default
