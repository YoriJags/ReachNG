...
CONTROL_ROOM_HOSPITALITY = {
    ...
    "money_panel": {
        ...
        "match_ref":     "#ALT-2614",
        "match_detail":  "Sat 9pm · DJ booth · ₦450k deposit · waiting for your bank confirmation",
        "draft":         "Hey Bola, thanks for the screenshot 🙏 I'll lock in your Saturday 9pm booking the moment ₦450k reflects on our end (usually under 10 mins). I'll ping you the second it lands.",
    },
    "timeline": [
        ...
        {"glyph": "₦", "state": "active",    "time": "SAT · 11:56 PM", "text": "<strong>Transfer screenshot received</strong> · GTB ₦450k → likely match booking #ALT-2614 · awaiting your bank confirmation"},
        {"glyph": "✉", "state": "active",    "time": "SAT · 11:56 PM", "text": "<strong>Conditional receipt drafted</strong> · waits in HITL until you verify funds landed"},
...
CONTROL_ROOM_REAL_ESTATE = {
    ...
    "money_panel": {
        ...
        "match_ref":     "#CRL-0418",
        "match_detail":  "3BR Victoria Island · viewing Sat 4pm · ₦12M refundable · waiting for your bank confirmation",
        "draft":         "Hi Damilola, thanks for the screenshot showing ₦12M viewing deposit for the 3-bed Victoria Island unit. Once it reflects on our end (usually under 30 mins for Zenith → Zenith), I'll lock in Saturday 4pm with Adeola at the gate. Refundable if you walk away. I'll ping you the second it lands.",
    },
    "timeline": [
        ...
        {"glyph": "₦", "state": "active", "time": "SAT · 11:56 PM", "text": "<strong>Viewing deposit screenshot received</strong> · Zenith ₦12M → likely match booking #CRL-0418 · awaiting your bank confirmation"},
...
CONTROL_ROOM_PROFESSIONAL_SERVICES = {
    ...
    "money_panel": {
        ...
        "match_ref":     "#GVP-2218",
        "match_detail":  "Fintech CBN licensing memo · Mon 11am · Partner Olu · waiting for your bank confirmation",
        "draft":         "Hi Mr Adebanjo, thanks for the screenshot showing ₦300k consultation fee. Once it reflects on our end (usually under 30 mins), I'll lock in Monday 11am with Olu (fintech regulation lead). Conflict check is cleared. Pre-call brief reaches you Sunday evening.",
    },
    "timeline": [
        ...
        {"glyph": "₦", "state": "active", "time": "FRI · 7:08 PM",  "text": "<strong>Consultation fee screenshot received</strong> · UBA ₦300k → likely match matter #GVP-2218 · awaiting your bank confirmation"},
        {"glyph": "📅","state": "active", "time": "FRI · 7:09 PM",  "text": "<strong>Provisional booking drafted</strong> · Monday 11am with Olu · invite holds until you tap confirm"},
