...
def _compose_confirmation_email(name: str, position: int, business_name: str) -> tuple[str, str, str]:
    ...
    text = (
        ...
        f"  3. From there it's 3 days to live: setup + voice on Day 1, calibration on Day 2, real customers on Day 3. By Day 4 morning, you get your first Owner Brief.\n\n"
      ...
      <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="560" style="max-width:560px;background:#ffffff;border-radius:14px;border:1px solid #E8DEC8;overflow:hidden;">
        ...
        <tr><td style="padding:24px 36px 8px 36px;font-size:15px;line-height:1.65;color:#3d3a33;">
          ...
          <ol style="margin:0 0 16px 0;padding-left:20px;">
            ...
            <li style="margin-bottom:8px;">Based on your answers, we may invite you into one of the first pilot batches. Priority applicants get a tailored WhatsApp demo within 48 hours.</li>
            <li style="margin-bottom:0;">From there it's 3 days to live: setup &amp; voice on Day 1, calibration on Day 2, real customers on Day 3. By Day 4 morning, you get your first Owner Brief.</li>
          </ol>
        </td></tr>
