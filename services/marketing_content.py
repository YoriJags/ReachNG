...
HOSPITALITY = {
    ...
    "sample_brand": "Altitude Lagos",
    "headline": "Stop losing tables to slow WhatsApp replies.",
    "subhead": "Your DMs are flooded. Last month's enquiries died in the inbox. Your guests message at 11pm and by morning they've booked your competitor. ReachNG resurrects every old enquiry, handles every new one in under 2 minutes, and recovers unpaid event deposits — your voice, your menu, your approval before send. One Owner Brief shows the cash about to land.",
...
REAL_ESTATE = {
    ...
    "subhead": "Lagos real estate leaks at the WhatsApp stage. Last quarter's warm-not-ready buyers are sitting in a spreadsheet, forgotten. Friday-night DMs ghost by Saturday. ReachNG resurrects every old buyer, drafts every new follow-up — qualifying, PoF, viewing booking — sends from your number with your approval. The same agent chases unpaid rent on managed units. One Owner Brief shows what's about to close and what's about to land.",
    "meta_description": "AI sales operator for Lagos real estate agents — Victoria Island, Ikoyi, Lekki, VI. Drafts buyer follow-ups, automates Proof of Funds, books viewings. ReachNG Closer.",
    ...
    "pain_points": [
        ...
        {"title": "Premium buyers expect premium response", "body": "A Victoria Island buyer with USD budget will not wait 4 hours for a reply. Tier-1 leads close with whoever responds first, period."},
    ],
...
PROFESSIONAL_SERVICES = {
    ...
    "subhead": "Retainer-sized clients email after hours and last quarter's leads are buried in someone's inbox. By the time your office opens Monday, they've hired your competitor. ReachNG resurrects every cold enquiry, triages the new ones, qualifies the matter, and books the paid consultation. Same agent chases unpaid invoices and outstanding fee notes. One Owner Brief shows retainers in motion.",
...
SMALL_BUSINESS = {
    ...
    "subhead": "Beauty, wellness, fitness, small services — your IG DMs are flooded, last month's customers stopped coming back, your bookings calendar is chaos, no-shows eat your weekends. ReachNG resurrects every lapsed customer, handles every new booking, takes every deposit via Paystack, and kills the no-show problem. One Owner Brief shows the chair-time about to land.",
