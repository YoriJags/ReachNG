...
_SEEDS: list[VerticalPrimer] = [
    ...
    VerticalPrimer(
        ...
        label="Hospitality (Restaurants, Bars, Hotels, Caterers)",
        vocabulary=[
            "reservation", "table", "minimum spend", "deposit", "private hire",
            "rooftop", "lounge", "VIP table", "owambe", "corporate event",
            "menu", "happy hour", "DJ slot", "small chops", "house rules", "dress code",
        ],
        default_tone="warm, hospitable, energetic, brand-confident",
        default_qualifying_questions=[
            "What date and time?",
            "How many people in the party?",
            "Is this a special occasion (birthday, corporate, date night)?",
            "Any dietary requirements or seating preferences?",
            "Have you visited us before?",
        ],
        default_objections=[
            "Minimum spend is too high",
            "Why is the deposit non-refundable",
            "I just want to walk in",
            "Can I get a discount for a group?",
            "Why do I need to book in advance?",
        ],
        default_cta="lock in your table with a deposit",
        compliance_notes=[
            "NAFDAC food/water registration must be current",
            "LASEPA noise + waste compliance for late-night venues",
            "No alcohol promotions targeting under-18s",
            "Health and safety signage compulsory",
        ],
        never_say_defaults=[
            "guaranteed seat next to the DJ",
            "we will close the restaurant for you (unless private hire)",
            "you will definitely meet [celebrity] here",
            "discount only available today",
        ],
        sample_one_liner="Rooftop bar and event space on VI — energetic Friday/Saturday programming, private events Monday–Wednesday.",
    ),

    VerticalPrimer(
        vertical="education",
        label="Education (Schools, Lesson Centres)",
        vocabulary=[
            "admissions", "prospectus", "tour", "open day", "year group",
            "term fees", "scholarship", "entrance assessment", "CAT4",
            "Cambridge", "WAEC", "JAMB", "registration", "deposit",
            "uniform", "transport", "after-school", "sixth form",
        ],
        default_tone="warm, reassuring, professional, parent-respectful",
        default_qualifying_questions=[
            "Which year group are you considering?",
            "When would the child be starting?",
            "Are you currently in Lagos or relocating?",
            "What was their previous school?",
            "Are you exploring boarding, day, or both?",
        ],
        default_objections=[
            "Fees are too high",
            "We're still considering other schools",
            "Is there a scholarship?",
            "Do you offer a payment plan?",
            "How do you compare to [competitor school]?",
        ],
        default_cta="book a school tour",
        compliance_notes=[
            "NDPR — minor data requires explicit parental consent",
            "Lagos State Ministry of Education registration must be current",
            "Curriculum representations (Cambridge / Edexcel / WAEC) must be accurate",
            "Never disparage another school by name in writing",
        ],
        never_say_defaults=[
            "we guarantee your child gets in",
            "scholarships are limited so apply now",
            "[competitor school] is going downhill",
            "all our students get into Ivy League",
        ],
        sample_one_liner="British curriculum school, Pre-K to Year 13, Lekki Phase 1 — strong Cambridge progression and active diaspora intake.",
    ),

    VerticalPrimer(
        vertical="professional_services",
        label="Professional Services (Law, Accounting, Consulting, Advisory)",
        vocabulary=[
            "consultation", "retainer", "engagement letter", "scope",
            "matter", "billable", "draft", "review", "due diligence",
            "advisory", "regulatory", "compliance", "litigation",
            "tax filing", "annual returns", "audit",
        ],
        default_tone="precise, trust-building, measured, partner-grade",
        default_qualifying_questions=[
            "Could you outline the matter briefly?",
            "Is there a court date, deadline, or regulatory window?",
            "Are we acting for an individual, company, or trust?",
            "Have you engaged counsel or another firm on this previously?",
            "What outcome would success look like for you?",
        ],
        default_objections=[
            "Fees seem high",
            "Can we just get a quick free opinion first?",
            "Why do I need to pay before the consultation?",
            "I want to discuss billing scope before engagement",
            "How do I know you don't have a conflict?",
        ],
        default_cta="book a paid consultation",
        compliance_notes=[
            "Confidentiality and conflict-checking are non-negotiable",
            "Fee scales must comply with the Legal Practitioners Act / ICAN / CITN as applicable",
            "Anti-money-laundering (AML) checks for new clients",
            "Engagement letter required before substantive advice",
            "Never make legal/tax/financial claims without qualifying as 'estimate, subject to formal review'",
        ],
        never_say_defaults=[
            "we guarantee you'll win",
            "this is straightforward, no need for an engagement letter",
            "ignore the deadline, we'll sort it later",
            "off the record",
        ],
        sample_one_liner="Lagos commercial law firm — corporate, property, dispute resolution. Tier-1 client base, partner-led matters.",
    ),

    VerticalPrimer(
        vertical="small_business",
        label="Small Business (Beauty, Wellness, Salons, Studios, Single-Site Services)",
        vocabulary=[
            "appointment", "deposit", "first-visit", "regular",
            "package", "loyalty", "fill-in", "touch-up", "consult",
            "booking", "no-show", "reschedule", "service menu",
            "Paystack", "OPay", "Moniepoint", "MoMo",
        ],
        default_tone="warm, friendly, informal-but-professional, lightly playful",
        default_qualifying_questions=[
            "Which service are you booking?",
            "Day and time that works?",
            "First visit or returning customer?",
            "Any allergies or skin concerns we should know about?",
            "Are you booking solo or with friends?",
        ],
        default_objections=[
            "Why do I need to pay a deposit?",
            "Can I just walk in?",
            "Why is it more than [competitor]?",
            "Can I bring my own products?",
            "Last time I came it wasn't great",
        ],
        default_cta="book your slot with a Paystack deposit",
        compliance_notes=[
            "NAFDAC-approved products only (cosmetics/skincare/hair products)",
            "LIRS presumptive tax — registration required above turnover threshold",
            "Hygiene/sterilisation logs (where applicable to beauty services)",
            "NDPR — customer phone numbers and photos require consent",
        ],
        never_say_defaults=[
            "guaranteed before/after results",
            "permanent / forever results",
            "results are 100% pain-free",
            "this product is dermatologist-approved (unless verified)",
        ],
        sample_one_liner="Beauty + wellness studio in Lekki — lashes, braids, brows, light spa. Bridal squad packages a specialty.",
    ),
]
