...
function showResult(data) {
  ...
  const clauseKeys = Object.keys(data.clauses || {}).filter(k => !["overall_risk","overall_summary","red_flags","parse_error"].includes(k));
  ...
  document.getElementById("stats-row").innerHTML = `
    ...
    <div class="stat"><div class="s-val">&lt;60s</div><div class="s-lbl">Review Time</div></div>
  `;
